...
@SpringBootTest
public class PortalProjectManagementServiceTest {
	...
	public void createPortalProjectTest() {
		...
		Mockito.when(createPortalProjectOperation.createPortalProject(portalDto)).thenReturn(portalDto);
		assertThat(portalProjectManagementService.createPortalProject(portalDto)).isEqualTo(portalDto);
	}
	...
	public void updatePortalProjectTest() {
		...
		Mockito.when(updatePortalProjectOperation.updatePortalProject(portalDto)).thenReturn(portalDto);
		assertThat(portalProjectManagementService.updatePortalProject(portalDto)).isEqualTo(portalDto);
	}
}
