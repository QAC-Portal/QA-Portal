...
import {APPROVED_STATUS, FAILED_REVIEW_STATUS, FOR_REVIEW_STATUS, IN_PROGRESS_STATUS} from '../_common/models/cv-status.constants';
...
export class ViewCvComponent {
  ...
  constructor(
    ...
    private viewCvStateManagerService: CvStateManagerService,
